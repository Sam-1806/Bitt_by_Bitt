...
function sub(){
    ...
    document.querySelector(".hamb").addEventListener("click", () => {
        ...
        document.querySelector(".right-sub").style.right = "220px";
        document.querySelector(".leftsec").style.filter = "opacity(20%)";
        
        
      });
    document.querySelector(".cross").addEventListener("click",()=>{
     
        document.querySelector(".right-sub").style.right="-500px";
        document.querySelector(".leftsec").style.filter = "opacity(100%)";
